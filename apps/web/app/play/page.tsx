...
export default function Play() {
  ...
  return (
    <>
      ...
      <div className="lg:min-h-screen bg-black flex flex-col lg:flex-row pt-16 sm:pt-18 relative overflow-hidden">
        ...
        {/* Left Side - Controls */}
        <div className="lg:flex-1 flex items-center lg:items-start justify-center pt-4 sm:pt-2 lg:pt-6 px-6 sm:px-8 lg:px-12 pb-8 lg:pb-0 relative z-10">
          <motion.div
